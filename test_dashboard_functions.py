...
class DashboardFunctionsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with self.app.app_context():
            ...
            db.execute("CREATE TABLE IF NOT EXISTS admin_users (id INTEGER PRIMARY KEY, username TEXT, password TEXT)")
            db.execute("INSERT INTO admin_users (username, password) VALUES (?, ?)", ("admin", "pass"))
            db.commit()
        # Log in as admin
